...
const ShardingTableContract = artifacts.require('ShardingTable');
const AssertionStorage = artifacts.require('AssertionStorage');
const AssertionContract = artifacts.require('Assertion');
const ServiceAgreementStorageV1 = artifacts.require('ServiceAgreementStorageV1');
const ServiceAgreementContractV1 = artifacts.require('ServiceAgreementV1');
...
module.exports = async (deployer, network, accounts) => {
  let hub, hashingProxy, sha256Contract, scoringProxy,
    log2pldsfContract, erc20Token;
  ...
  const initializeContract = async (
    ...
    if (!deployedContracts.contracts[contractName]?.deployed) {
      ...
      console.log(
        `${contractName} contract already deployed at address: ${deployedContracts.contracts[contractName].evmAddress}`,
      );
