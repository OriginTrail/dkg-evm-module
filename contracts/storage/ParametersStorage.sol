...
contract ParametersStorage is INamed, IVersioned, HubDependent {
    ...
    function setV812ReleaseEpoch(uint256 _v812ReleaseEpoch) external onlyHub {
        v812ReleaseEpoch = _v812ReleaseEpoch;

        emit ParameterChanged("v812ReleaseEpoch", _v812ReleaseEpoch);
    }
}
