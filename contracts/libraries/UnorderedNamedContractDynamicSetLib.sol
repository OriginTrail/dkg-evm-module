...
library UnorderedNamedContractDynamicSetLib {
    ...
    function append(UnorderedNamedContractDynamicSetLib.Set storage self, string calldata name, address addr) internal {
        require(
        ...
        self.contractList.push(UnorderedNamedContractDynamicSetLib.Contract(name, addr));
    }

    function update(UnorderedNamedContractDynamicSetLib.Set storage self, string calldata name, address addr) internal {
        require(addr != address(0), "NamedContractSet: Address cannot be 0x0");
    ...
    function remove(UnorderedNamedContractDynamicSetLib.Set storage self, string calldata name) internal {
        ...
        UnorderedNamedContractDynamicSetLib.Contract memory contractToMove = self.contractList[size(self) - 1];
    ...
    function remove(UnorderedNamedContractDynamicSetLib.Set storage self, address addr) internal {
    ...
    function get(
        UnorderedNamedContractDynamicSetLib.Set storage self,
        string calldata name
    ) internal view returns (UnorderedNamedContractDynamicSetLib.Contract memory) {
        require(exists(self, name), "NamedContractSet: Contract with given name doesn't exist");
    ...
    function exists(UnorderedNamedContractDynamicSetLib.Set storage self, address addr) internal view returns (bool) {
        if (size(self) == 0) {
            return false;
        }
    ...
    function size(UnorderedNamedContractDynamicSetLib.Set storage self) internal view returns (uint256) {
