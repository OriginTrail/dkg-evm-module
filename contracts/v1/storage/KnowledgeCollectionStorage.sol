...
import {IERC1155DeltaQueryable} from "../interface/IERC1155DeltaQueryable.sol";
...
contract KnowledgeCollectionStorage is Named, Versioned, HubDependent, IERC1155DeltaQueryable, ERC1155Delta, Guardian {
    ...
    constructor(address hubAddress) ERC1155Delta("") Guardian(hubAddress) {
        knowledgeCollectionMaxSize = 1024;
    }
    ...
    function setURI(string memory baseURI) external onlyHubOwner {
        _setURI(baseURI);
