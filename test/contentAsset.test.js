...
contract('DKG v6 assets/ContentAsset', async (accounts) => {
  ...
  //         assert(
  //           error.message.startsWith(errorPrefix + 'revert ERC721: invalid token ID'),
  ...
  //         assert(error, 'Expected error but did not get one');
  //         assert(
  //           error.message.startsWith(errorPrefix + 'revert Only owner can update an asset'),
  //           'Invalid error message received: ' + error.message
  //         );
  //     }
  // });
  ...
  //         assert(error, 'Expected error but did not get one');
  //         assert(
  //           error.message.startsWith(errorPrefix + 'revert assertionId cannot be 0'),
  //           'Invalid error message received: ' + error.message
  //         );
  //     }
  // });
  ...
  //         assert(error, 'Expected error but did not get one');
  //         assert(
  //           error.message.startsWith(errorPrefix + 'revert Size cannot be 0'),
  //           'Invalid error message received: ' + error.message
  //         );
  //     }
  // });
  ...
  //         assert(error, 'Expected error but did not get one');
  //         assert(
  //           error.message.startsWith(errorPrefix + 'revert Epochs number cannot be 0'),
  //           'Invalid error message received: ' + error.message
  //         );
  //     }
  // });
  ...
  //         assert(error, 'Expected error but did not get one');
  //         assert(
  //           error.message.startsWith(errorPrefix + 'revert Token amount cannot be 0'),
  //           'Invalid error message received: ' + error.message
  //         );
  //     }
  // });
